...
#            print(t_supp)
    ...
    def do(self):      
        ...
        #                         break #no need continue ,We have supposed the elements be sequential
            ...
            k += 1
            #print(ls)
            print("The"+str(k-2)+" itemsets are completed!")
        for t in range(ls.size()):
            if len(ls.get(t+1).items)==0:
                ls.remove(t+1)
        return ls
...
min_kulc=0.0000001
thresh_ir=100000000
a = Apriori(min_supp,os.getcwd()+"/test.csv")
#a = Apriori(min_supp,os.getcwd()+"/INTEGRATED-DATASET.csv")
#print(a)
ls = a.do()
print(ls)
